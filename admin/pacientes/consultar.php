                ...
                <form class="row g-4 needs-validation" novalidate action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                    <div class="col-md-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Buscar por DNI, ID o Teléfono" name="busqueda" required>
                            <label for="busqueda">Buscar por DNI, ID o Teléfono</label>
                        </div>
                    </div>
                                            ...
                                            <td class="row-buttons">
                                                <div class="d-flex">
                                                    ...
                                                    <button 
                                                        ...
                                                        data-delete-name="<?=$paciente['nombre']." ".$paciente['apellido']?>"
