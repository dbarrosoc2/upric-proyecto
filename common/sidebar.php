    ...
    <?php if (isset($panelAdmin)) { ?>
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="pacientes-nav" class="nav-content <?php echo str_contains($_SERVER['REQUEST_URI'], "pacientes") ? "" : "collapse" ?> " data-bs-parent="#sidebar-nav
                ">
            ...
            <a class="nav-link <?php echo str_contains($_SERVER['REQUEST_URI'], "usuarios") ? "" : "collapsed" ?>" data-bs-target="#pacientes-nav" data-bs-toggle="collapse" href="#" aria-expanded="true">
                <i class="bi bi-file-person"></i>
                <span>Usuarios
            ...
            <ul id="pacientes-nav" class="nav-content <?php echo str_contains($_SERVER['REQUEST_URI'], "pacientes") ? "" : "collapse" ?> " data-bs-parent="#sidebar-nav
                ...
                <li>
                    <a href="<?= $url_base ?>/admin/usuarios/altaUsuarios.php" class="<?php echo preg_match('(pacientes)', $_SERVER['REQUEST_URI']) && preg_match('(alta)', $_SERVER['REQUEST_URI']) ? "active" : "" ?>">
                        <i class="bi bi-circle"></i><span>Alta</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $url_base ?>/admin/usuarios/consultarUsuario.php" class="<?php echo preg_match('(pacientes)', $_SERVER['REQUEST_URI']) && preg_match('(alta)', $_SERVER['REQUEST_URI']) ? "active" : "" ?>">
                        <i class="bi bi-circle"></i><span>Consultar</span>
                    </a>
                </li>
            </ul>
